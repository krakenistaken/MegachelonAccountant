    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-100">
          ...
          <div>
            <h1 className="text-base font-bold text-gray-900 leading-tight">Megachelon</h1>
            <p className="text-xs text-gray-500 font-medium">Muhasebe Paneli</p>
          </div>
          {/* Mobile close */}
          <button
            onClick={onClose}
            className="ml-auto lg:hidden p-1.5 rounded-lg hover:bg-gray-100 text-gray-500"
          >
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        ...
        <div className="border-t border-gray-100 p-4">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-xl text-sm font-medium
              text-gray-600 hover:text-danger-600 hover:bg-danger-50 transition-all duration-200
              disabled:opacity-50"
          >
